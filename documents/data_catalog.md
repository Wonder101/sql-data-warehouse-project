...
## Overview
The Gold Layer represents data at the business level, structured to support analytical and reporting use cases. It consists of dimension tables and fact tables for specific business metrics.
